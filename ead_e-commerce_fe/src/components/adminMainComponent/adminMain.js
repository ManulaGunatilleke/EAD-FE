...
export default function AdminMain() {
  ...
  const vendorsCount = users.filter(
        ...
        <div className="row mt-4 text-center">
          <div className="col-md-4">
            <div className="box p-4 boxvendor">
              ...
              <p className="boxp">
                Approve or reject the products submitted to cart.io
              </p>
          ...
          <div className="container-fluid">
            <div className="row g-3 my-2">
              <div className="col-md-3 p-1">
                <div
                  className="p-3 shadow-sm d-flex justify-content-around align-items-center rounded"
                ...
                >
                  ...
                  <i
                    className="bi bi-person-fill p-3"
                    style={{ fontSize: "5rem" }}
                  ></i>
                </div>
              </div>
              ...
              <div className="col-md-3 p-1">
                ...
                >
                  <div>
                    ...
                    <p className="fs-3 fw-bold">CSRs</p>
                  </div>
                  <i
                    className="bi bi-person-workspace p-3"
                    style={{ fontSize: "5rem" }}
                  ></i>
                </div>
              </div>
              <div className="col-md-3 p-1">
                ...
                >
                  ...
                  <i
                    className="bi bi-people-fill p-3"
                    style={{ fontSize: "5rem" }}
                  ></i>
                </div>
              </div>
            ...
            <div className="row g-3 my-1">
              <div className="col-md-6">
                ...
                >
                  <h4 className="text-center text-black">Analysis of User Count</h4>
              ...
              <div className="col-md-6">
                ...
                >
                  <h4 className="text-center text-black">Share of the Users @ cart.io</h4>
